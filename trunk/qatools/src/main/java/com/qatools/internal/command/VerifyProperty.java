...
/**
 */
@AutomationCommand(name = "VERIFY_PROPERTY")
public class VerifyProperty implements ActionCommand {

    /**
     * slf4j Logger instance.
     */
    private static final Logger LOG = LoggerFactory
            .getLogger(VerifyProperty.class);
            ...
            if (StringUtils.isNotBlank(name) && StringUtils.isNotBlank(value)) {
                ...
                if (element != null) {
                    ...
                    if (StringUtils.isNotBlank(attributeValue)
                        ...
                        status.setStatusDesc("Got attribute value '"
